...
xcode_build_target "iphonesimulator9.0" "${BUILDCONFIGURATION}" "i386" "6.1" "i386"
xcode_build_target "iphonesimulator9.0" "${BUILDCONFIGURATION}" "x86_64" "7.0" "x86_64"
xcode_build_target "iphoneos9.0" "${BUILDCONFIGURATION}" "armv7" "6.1" "Arm"
xcode_build_target "iphoneos9.0" "${BUILDCONFIGURATION}" "armv7s" "6.1" "Arm7S"
xcode_build_target "iphoneos9.0" "${BUILDCONFIGURATION}" "arm64" "7.0" "Arm64"
